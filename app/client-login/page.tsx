    ...
    <div style={{minHeight:"100vh",background:"var(--page-bg)",display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
      ...
      <div className="anim-up" style={{width:"100%",maxWidth:380}}>
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <h1 style={{fontSize:22,fontWeight:700,color:"var(--tx-primary)",letterSpacing:"-0.02em"}}>Client Portal</h1>
          <p style={{fontSize:13.5,color:"var(--tx-tertiary)",marginTop:5}}>View your project progress</p>
        </div>
        ...
        <div style={{display:"flex",justifyContent:"center",gap:24,marginTop:18}}>
          ...
          <a key="/employee-login" href="/employee-login" style={{fontSize:12.5,color:"var(--tx-tertiary)",textDecoration:"none",transition:"color .12s"}} onMouseEnter={e=>(e.currentTarget.style.color="var(--tx-primary)")} onMouseLeave={e=>(e.currentTarget.style.color="var(--tx-tertiary)")}>Employee login</a>
        </div>
      </div>
    </div>
  );
